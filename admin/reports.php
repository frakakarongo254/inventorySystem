	    ...
	    <div class="col-md-8">
		 ...
		 <div class="table-responsive">
				...
				<!-- <tr type="hidden">
				 ...
				 <td><input class="form-control" type="date" id="statePurchaseDate" name="statePurchaseDate"></td>
				 <td><input class="form-control" type="date" id="endPurchaseDate" name="endPurchaseDate"></td>
				 <td><button class="button btn-primary form-control" type="button" id="purchaseButton" onclick="showPurchaseReport()">Show</button></td>
				 </tr> -->
				 	</form>			
				 </tbody>
				 </table>
